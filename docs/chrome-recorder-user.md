...
3. If prompted, choose **Install Chrome Extension** and complete installation in the Chrome Web Store.
4. Return to Automation Tool and choose **Connect Recorder**.
5. Choose **Open Recorder**.
